...
package bkde.as3.boards {
  ...
  public class GraphingBoard extends Sprite {
	...
	public var ErrorBox:TextField;
	  ...
	  public function GraphingBoard(h:Number){
		...
		setErrorBoxSizeAndPos(nSize-20,nSize/3,10,10);
		...
		setCoordsBoxSizeAndPos(60,40,20,Math.max(nSize-50,0));
  ...
  protected function drawMask():void {
	...
	spMask.graphics.lineTo(nSize+1,1);
	
	spMask.graphics.lineTo(nSize+1,nSize+1);
	
	spMask.graphics.lineTo(0,nSize+1);
  ...
  protected function drawBoard():void {
   ...
   protected function drawBorder():void {
	   ...
	   shBorder.graphics.lineTo(nSize,0);
	
	   shBorder.graphics.lineTo(nSize,nSize);
	
	   shBorder.graphics.lineTo(0,nSize);
