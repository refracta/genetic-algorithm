...
public class GraphViewScene extends Scene {
	...
	public function GraphViewScene(mainUserInterface:MainUserInterfaceWrapper, entityGroup:Vector.<BinaryEntity>) {
		this.mainUserInterface = mainUserInterface;
		this.entityGroup = entityGroup;
	}

	public  function getBestEntity(binaryEntities:Vector.<BinaryEntity>):BinaryEntity {
		sortVector(entityGroup);
	...
	override public function init():void {
		...
		bestEntity.setText("최고 개체 : " + getBestEntity(entityGroup).toString() + " ");
		bestEntity.x = 0;
	...
	public function sortVector(entities:Vector.<BinaryEntity>) {
